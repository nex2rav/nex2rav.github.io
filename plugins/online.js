(function () {
	...
	var defineGlobalProperty$3 = function (key, value) {
	  try {
	    defineProperty$4(globalThis$f, key, { value: value, configurable: true, writable: true });
	  } catch (error) {
	...
	var toString$c = uncurryThis$m(1.1.toString);
	...
	var isForced$2 = function (feature, detection) {
	  ...
	  return value === POLYFILL ? true
	    : value === NATIVE ? false
	    : isCallable$5(detection) ? fails$h(detection)
	    : !!detection;
	};
	...
	*/
	...
	var FORCED$6 = NEGATIVE_ZERO$1 || !arrayMethodIsStrict$4('indexOf');
	...
	var FORCED$5 = $parseInt$1(whitespaces$1 + '08') !== 8 || $parseInt$1(whitespaces$1 + '0x16') !== 22
	  ...
	  || (ITERATOR && !fails$d(function () { $parseInt$1(Object(ITERATOR)); }));
	...
	$$7({ target: 'Array', proto: true, forced: lastIndexOf !== [].lastIndexOf }, {
