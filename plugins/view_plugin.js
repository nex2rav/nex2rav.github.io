(function () {
	...
	var toString$5 = uncurryThis$b(1.1.toString);
	...
	var makeBuiltIn$1 = makeBuiltIn$2.exports = function (value, name, options) {
	  ...
	  if (!hasOwn$3(value, 'name') || (CONFIGURABLE_FUNCTION_NAME && value.name !== name)) {
	    if (DESCRIPTORS$3) defineProperty(value, 'name', { value: name, configurable: true });
	  ...
	  try {
	    if (options && hasOwn$3(options, 'constructor') && options.constructor) {
	      if (DESCRIPTORS$3) defineProperty(value, 'prototype', { writable: false });
	...
	*/
	...
	var doesNotExceedSafeInteger$1 = function (it) {
	  if (it > MAX_SAFE_INTEGER) throw new $TypeError$2('Maximum allowed index exceeded');
	  return it;
	};
